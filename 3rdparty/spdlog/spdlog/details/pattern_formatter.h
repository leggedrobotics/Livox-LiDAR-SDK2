...
struct padding_info
{
  ...
  padding_info(size_t width, padding_info::pad_side side) : width_(width), side_(side)
  {
  }
...
{
public:
  scoped_pad(size_t wrapped_size, padding_info& padinfo, fmt::memory_buffer& dest) : padinfo_(padinfo), dest_(dest)
  {
